            ...
            <Card className="border-zinc-200 shadow-sm overflow-hidden relative">
              ...
              <div className="px-6 pb-6 -mt-10 relative">
                ...
                <p className="text-xs text-zinc-500 mb-4">
                  {selectedStudent.course} • Matrícula Ativa
                </p>
            ...
            <Card className="border-zinc-200 shadow-sm">
              ...
              <CardContent className="p-0">
                <div className="divide-y divide-zinc-100">
                  {[
                    { nome: 'Cálculo Avançado', media: 8.5, freq: '95%', status: 'Acima da Média' },
                    { nome: 'Física Clássica', media: 7.0, freq: '88%', status: 'Na Média' },
                    { nome: 'Estatística Aplicada', media: 5.5, freq: '78%', status: 'Atenção' },
                  ].map((disc) => (
                    <div
                      key={disc.nome}
