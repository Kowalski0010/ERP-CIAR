    ...
    <div className="space-y-6 animate-fade-in-up pb-8 max-w-[1200px] mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-2">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-zinc-900 flex items-center gap-2">
            <Truck className="h-7 w-7 text-zinc-400" />
            Fornecedores
          </h1>
          <p className="text-sm text-zinc-500 mt-1">
            Gestão de fornecedores, contratos de prestação de serviços e parceiros.
          </p>
        </div>
      </div>
      <Card className="border-zinc-200 shadow-sm">
        ...
        <CardContent className="p-12 flex flex-col items-center justify-center text-center">
          <Truck className="h-16 w-16 text-zinc-200 mb-4" />
