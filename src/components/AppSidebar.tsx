...
const appModules = [
  {
    ...
    items: [
      ...
      { title: 'Alteração de Dados Pessoais', url: '/student/profile-edit' },
      ...
      { title: 'Requisição de Documentos', url: '/student/document-requests' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Relatórios', url: '/admin/general-reports' },
      { title: 'Manutenção de Horários', url: '/admin/schedule-maintenance' },
      { title: 'Planos de Pagamento', url: '/admin/payment-plans' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Histórico Escolar', url: '/academic/student-history' },
      { title: 'Dispensa de Disciplinas', url: '/academic/course-exemptions' },
      { title: 'Afastamento de Alunos', url: '/academic/student-leaves' },
